        ...
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <p><asp:Panel ID="ExternalPanel" runat="server"></asp:Panel>
                        <p>
                        </p>
                        <p>
                        </p>
                ...
                <div class="col-md-4">
                    <h2>Servers</h2>
                    <p><asp:Panel ID="ServersPanel" runat="server"></asp:Panel>
                        <p>
                        </p>
                        <p>
                        </p>
                ...
                <div class="col-md-4">
                    ...
                    <p><asp:Panel ID="InternalPanel" runat="server"></asp:Panel>
                        <p>
                        </p>
                        <p>
                        </p>
            ...
            <div>Details last updated at <asp:Label ID="TimeLabel" runat="server" Text="Label"></asp:Label></div>
        </ContentTemplate>
        <triggers>
